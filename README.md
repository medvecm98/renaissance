...
```
$ java -jar 'renaissance-gpl-0.17.1.3m.jar' <benchmarks>
```
...
```
Renaissance Benchmark Suite, version 0.17.1.3m
...
```
$ java -jar 'renaissance-jmh/target/renaissance-jmh-0.17.1.3m.jar'
```
