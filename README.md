...
```
$ java -jar 'renaissance-gpl-0.17.1.4m.jar' <benchmarks>
```
...
```
Renaissance Benchmark Suite, version 0.17.1.4m
...
```
$ java -jar 'renaissance-jmh/target/renaissance-jmh-0.17.1.4m.jar'
```
